...
}(typeof window === 'undefined' ? this : window));define('piewpiew.views', ['underscore', 'backbone', 'piewpiew.core', 'jquery'], function(_, Backbone, piewpiew, $) {
...
function(_, piewpiew) {
  ...
  forms.Form = piewpiew.Class({
    initialize: function(attributes, options) {
      this.fields || (this.fields = {});

      console.log("create form");
      // TODO: If the form is associated with a model, we should
      // 'copy' fields from the model to this.fields if no corresponding
      ...
      if (this.model) {
        ...
        _.each(this.model.prototype.fields, function(field, name) {
          if (that.fields[name] == null) {
            console.log("Need to copy field " + name + " from model to form");

            console.log(field instanceof piewpiew.models.fields.EmailField)
          }
        });
      }
