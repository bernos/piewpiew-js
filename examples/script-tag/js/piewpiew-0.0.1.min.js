...
define('piewpiew.config', ['piewpiew.core'], function(piewpiew) {
  ...
  config.PRODUCTION   = "production";
    ...
    initialize: function(options) {
      ...
      if (options.environment == config.DEVELOPMENT 
        || options.environment == config.TESTING 
        || options.environment == config.PRODUCTION) 
      {
        this.setEnvironment(options.environment);
      }
      else
      {
        this.setEnvironment(config.DEVELOPMENT);
      }
